...
// Scenario metadata (numbers + colors); labels/descriptions come from i18n.
const SCENARIOS = {
...
const REVENUE: Record<ScenarioId, number[]> = {
...
// EBITDA (USD M)
const EBITDA: Record<ScenarioId, number[]> = {
...
const EBITDA_PCT: Record<ScenarioId, number[]> = {
...
const FCF: Record<ScenarioId, number[]> = {
...
const EV: Record<ScenarioId, number[]> = {
...
const PRE_MONEY_DCF: Record<ScenarioId, Record<number, number>> = {
...
function calcDCF(scenario: ScenarioId, horizon: number) {
...
// ─── MAIN APP ──────────────────────────────────────────────────────────────
type TabId = "overview" | "capex" | "revenues" | "valuation" | "premoney" | "billion";
const TAB_IDS: TabId[] = ["overview", "capex", "revenues", "valuation", "premoney", "billion"];
